...
var maxresults = 10
var partsize = 60*15 // size of the audio chunks in seconds
...
alexaplayer.prototype.handle = function () {
	...
	if (requestType === "LaunchRequest") {
		...
		this.speak('Welcome to Echotube Player. What do you want to play?', true)

	} else if (requestType === "IntentRequest") {
		var intent = this.event.request.intent;

		// if (!process.env['API_KEY']){
		//     this.speak('Youtube API KEY Environment Variable not set!')
		// }
		...
		if (intent.name === "SearchIntent") {
			...
			search(alexaUtteranceText, opts, function(err, results) {
				if(err) {
					...
					console.log(err)
					searchFunction.speakWithCard('I got an error from the Youtube API. Check the API Key has been copied into the Lambda environment variable properly', 'YOUTUBE API ERROR', 'I got an error from the Youtube API. \nCheck the API Key has been copied into the API_KEY Lambda environment variable properly')
...
alexaplayer.prototype.play = function (audioURL, offsetInMilliseconds,  tokenValue) {
...
alexaplayer.prototype.enqueue = function (audioURL, offsetInMilliseconds, tokenValue, previousToken) {
...
alexaplayer.prototype.nextResult = function () {
...
alexaplayer.prototype.previous = function () {
...
alexaplayer.prototype.processResult = function (partnumber, enqueue, offset) {
	...
	var audioStreamInfo = ytdl.getInfo(url, { filter: function(format) { return format.container === 'm4a'; } }, function (err,info){
		...
		// ignore content longer than 1 hour
		if (contentduration > 60*60){

			console.log('Audio longer than 1 hour - for track', currentresult);
...
alexaplayer.prototype.speakWithCard = function (responseText, cardTitle, cardText) {
	//console.log('speaking result')
	var imageURL = 'https://cdn3.iconfinder.com/data/icons/social-circle/512/social_4-512.png';
	var response = {
		version: "1.0",
		"sessionAttributes": {},
		response: {
...
alexaplayer.prototype.autoMode = function (mode) {
...
alexaplayer.prototype.shuffle = function (mode) {
...
alexaplayer.prototype.loop = function (mode) {
...
alexaplayer.prototype.resetmax = function () {
...
alexaplayer.prototype.raisemax = function () {
...
alexaplayer.prototype.createPlaylist = function(currentresult) {
...
alexaplayer.prototype.help = function(currentresult) {
	...
	var cardtext = '1. Request a particular video: "Alexa, ask Echotube Player to play Charley bit my finger"\n' +
	'2. Request an auto generated playlist of 25 results: - "Alexa ask Echotube Player to play SOME David Bowie"\n' +
	...
	'7. Find out what is playing by asking "Alexa ask Echotube Player whats playing - this will also tell you your data usage"\n' +
	...
	'11. Increae the data limit (this will allow the skill to incur data charges from AWS):- "Alexa, ask Echotube Player to increase the data limit"\n' +
	'12. Reset the data limit to default of 1000MB:- "Alexa, ask Echotube Player to reset the data limit"';

	var cardTitle = 'Echotube Player Skill Commands';

	this.speakWithCard ('Please see the Alexa app for a list of commands that can be used with this skill', cardTitle, cardtext)

}

alexaplayer.prototype.upload = function(enqueue, offset) {
